    ...
    return (
        ...
        <>
            ...
            <div className='container contacts mx-auto'>
                ...
                <form className="mx-auto block px-3 md:px-10 md:w-8/12 client-contact-form" name="_captcha" value="false" action="https://formsubmit.co/sttr2130@gmail.com" method="POST">
